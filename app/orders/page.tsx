      ...
      <div className="container mx-auto px-4 py-32">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-display font-bold text-gray-800 mb-2">My Orders</h1>
          ...
          {orders.length === 0 ? (
            ...
            <div className="space-y-6">
              {orders.map((order) => (
                <Card key={order._id} className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
                  <CardHeader>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="text-right">
                          ...
                          <p className="text-xl font-bold text-pink-600">{order.totalAmount.toLocaleString()} RWF</p>
                        </div>
                ...
                <div className="space-y-3">
                  {selectedOrder.items.map((item, index) => (
                    <div key={index} className="flex items-center space-x-4 p-3 border rounded-lg">
                      ...
                      <p className="font-bold text-pink-600">{(item.price * item.quantity).toLocaleString()} RWF</p>
                    </div>
                  ))}
                </div>
              </div>
